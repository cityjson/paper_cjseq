...
As a concrete example, we have implemented CityJSONSeq in the PostgreSQL, using \emph{cjdb}~\citep{Powalka23}, to store independently one feature per row in the database.
