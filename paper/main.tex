...
\documentclass[11pt,halfparskip,parskip=half]{scrartcl}
...
\lstset{style=mystyle,basicstyle=\ttfamily\scriptsize,breaklines=true}
...
\definecolor{Mycolour1}{HTML}{D9D7F1}
\definecolor{Mycolour2}{HTML}{FD9AEF}
\definecolor{Mycolour3}{HTML}{E7FBBE}
\definecolor{Mycolour4}{HTML}{9AD0EC}
\definecolor{Mycolour5}{HTML}{FBD6D2}
\definecolor{Mycolour6}{HTML}{b3b3b3}
\definecolor{Mycolour7}{HTML}{F2F2F2}
\usepackage[tikz]{mdframed}
\newmdenv[%
  outerlinewidth=2pt,%
  roundcorner=10pt,%
  linecolor=Mycolour6,%
  backgroundcolor=Mycolour7,%
]{myframe}
...
It is posted here only for personal use, not for redistribution and not for commercial use.
The definitive version will be published on the ISPRS website soon.
\\
\\
Hugo Ledoux, Gina Stavropoulou, and Balázs Dukai (2024). Streaming CityJSON datasets. Proceedings 3D GeoInfo 2024.
% \\\textsc{doi}: \url{http://dx.doi.org/10.1186/s40965-018-0043-x}
\\
\\
The code of the project is available at
\\
\url{https://github.com/cityjson/cjseq/}
\\
The reproducibility repository of the paper:
\\
\url{https://github.com/cityjson/paper_cjseq}
\end{myframe}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{cj_idea}
...
We discuss in    adfd Section~\ref{sec:experiments} the reasons for this interesting finding.
...
\begin{figure*}[th]
  \centering
  \includegraphics[width=0.95\linewidth]{cjseq_idea}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\textwidth]{compression_random.pdf}
    \caption{}%
  \label{fig:compression_random}
  \end{subfigure}%
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=\textwidth]{compression_adjacent.pdf}
    \caption{}%
