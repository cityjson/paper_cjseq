...
% TODO: not sure the shared vertices has a huge impact to be honest.
...
Notice that the dataset \textbf{3DBV} contains the ground that has been triangulated, and a few large areas are stored as \texttt{LandUse} and contain several triangles, this is the reason why the maximum memory use is larger than for other datasets. 
