...
We present \emph{CityJSON Text Sequences} (CityJSONSeq in short), a format based on \emph{JSON Text Sequences} and CityJSON\@. 
...
Since datasets of 3D cities are nowadays very large (it is not uncommon to have CityGML-XML files over 2GB), the processing CityJSON files is an issue in practice.
